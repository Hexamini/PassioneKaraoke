...
Come si può ben vedere, i colori non ``degradano'' in maniera elegante, causando una distorsione troppo forte. Si è quindi deciso di cambiarli, mantenendo solamente il logo (aggiunto successivamente) con la scritta rossa. Qui abbiamo ottenuto i seguenti risultati:
\begin{itemize}
