...
\paragraph*{Gerarchizzazione ad albero}La struttura HTML adottata \`e una struttura ad albero. Questra considera come nodo padre il file \textit{page.html}, e tutte le altre pagine come figli derivanti da esso.
...
\paragraph*{artist.html} artist.html è la struttura HTML che permette di rappresentare il profilo di un singolo artista. Il cantautore, o la band, sarà accompagnato, dopo un breve descrizione, dalla lista dei suoi album presenti nel sito. Non è possibile da parte dell'utente esprimere qualsiasi tipo di preferenze nè applicare qualsiasi modifica, che invece sarà compito dell'amministratore tramite la \textit{modalità amministrativa}.
